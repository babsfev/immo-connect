...
function NewPropertyForm() {
  ...
  // State local pour l'image (pour pouvoir l'envoyer dans le FormData)
  // Note: Dans une vraie app, ImageUpload gère l'upload async et renvoie une URL string.
  // Ici, notre composant ImageUpload renvoie un objet File.
  // Pour simplifier l'exemple sans upload cloud complexe, on va simuler.
  ...
  const handleSubmit = (formData: FormData) => {
    ...
    // Gestion de l'image (Simulation : on n'envoie pas le binaire au server action ici pour l'instant)
    // Idéalement : Upload vers S3/Supabase Storage d'abord, puis envoi de l'URL.
    if (imageFile) {
        // Pour l'instant, on ignore l'upload réel car createProperty attend une string URL
        // formData.append("coverImage", "https://via.placeholder.com/400"); 
    }
    ...
    <div className="max-w-3xl mx-auto py-8 px-4 sm:px-0 animate-in fade-in duration-500">
      ...
      <form action={handleSubmit} className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200 space-y-8">
         ...
         <div>
            ...
            <div className="mt-2">
                {/* 👇 CORRECTION ICI : Utilisation des bonnes props */}
                <ImageUpload 
                    name="coverImage" // Sera ignoré par le server action si pas géré, mais utile pour form
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div>
                 ...
                 <CurrencyInput 
                    ...
                    name="price" 
                    placeholder="0" 
                    error={getError("price")} // CurrencyInput propage l'erreur à Input
                 />
             </div>
         </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
             <div className="md:col-span-2">
                 ...
                 {/* 👇 CORRECTION : icon au lieu de className pl-10 manuelles */}
                 <Input 
                    id="address" 
                    name="address" 
