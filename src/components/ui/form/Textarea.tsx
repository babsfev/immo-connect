  ...
  ({ className, label, error, ...props }, ref) => {
    ...
    return (
      <div className="space-y-1.5 w-full">
        ...
        <textarea
          className={cn(
            "flex min-h-20 w-full rounded-xl border bg-white px-3 py-2 text-sm placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all",
            hasError 
...
// Export nommé pour la cohérence
export { Textarea };