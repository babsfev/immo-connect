  ...
  return (
    <div className="h-full rounded-2xl bg-slate-900 p-6 text-white shadow-xl relative overflow-hidden flex flex-col justify-center items-center text-center group border border-slate-800">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center mb-4 backdrop-blur-md border border-white/10 text-purple-300">
           <Sparkles size={24} />
        </div>
        ...
        <Badge className="bg-purple-500/20 text-purple-200 border-purple-500/30 px-3 py-1 flex items-center gap-1.5">
