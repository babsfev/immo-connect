      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            {/* CurrencyInput utilise aussi 'error' maintenant */}
        ...
        <div>
          ...
          <CurrencyInput
            ...
            error={getError("rentAmount")} // On passe l'erreur directement
          />
          <p className="text-xs text-slate-400 mt-1">
            Le premier paiement sera généré automatiquement avec ce montant.
          </p>
          {/* Plus besoin d'ErrorMessage séparé si CurrencyInput gère l'erreur, sinon : */}
